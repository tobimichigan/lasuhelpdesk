...
?>
    ...
    <div id="main">
            <h1>Thank You for Choosing LASU Electronic Helpdesk!</h1>
            <div id="intro">
            ...
            <h2>Prerequisites.</h3>
            <p>Before we begin, we'll check your server configuration to make sure you meet the minimum requirements to install and run LASU Eletronic Helpdesk.</p>
            <h3>Required: <font color="red"><?php echo $errors['prereq']; ?></font></h3>
            These items are necessary in order to install and use Lagos State University Electronic Help Desk .
            <ul class="progress">
