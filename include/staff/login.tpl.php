...
?>
<div id="loginBox">
    <h1 id="logo"><a href="index.php">LASU E-HelpDesk Staff Control Panel</a></h1>
...
<div id="copyRights">Copyright &copy; 1983- <?php echo date(Y); ?> <a href='http://www.lasu.edu.ng' target="_blank">LASU ICTC</a></div>
</body>
</html>
